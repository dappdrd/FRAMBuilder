                        ...
                        If cwtsubset(l)("Fishery") = 3311 Or cwtsubset(l)("Fishery") = 3315 Then
                            ...
                            ElseIf (Month(cwtsubset(l)("RecoveryDate")) >= 7 And Month(cwtsubset(l)("RecoveryDate")) <= 9) Then
                                If cwtsubset(l)("RecoverySite").ToString.Contains("872155") Or cwtsubset(l)("RecoverySite").ToString.Contains("872585") = True Then
                                    ...
                                    cwtsubset(l)("finalFmap") = fram_match 'Rewire accordingly
                                ElseIf cwtsubset(l)("RecoverySite").ToString.Contains("872477") Or cwtsubset(l)("RecoverySite").ToString.Contains("872286") Or cwtsubset(l)("RecoverySite").ToString.Contains("872408") Or cwtsubset(l)("RecoverySite").ToString.Contains("872232") Or cwtsubset(l)("RecoverySite").ToString.Contains("872046") Or cwtsubset(l)("RecoverySite").ToString.Contains("872024") = True Then
